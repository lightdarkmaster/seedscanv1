...
class _YoloVideoState extends State<YoloVideo> {
  ...
  // Adjust the bounding boxes based on the available screen size
  List<Widget> displayBoxesAroundRecognizedObjects(Size screen, BuildContext context) {
    ...
    // Get the padding for the top and bottom (status bar, app bar, bottom nav bar)
    ...
    final double availableHeight = screen.height - appBarHeight - bottomPadding - topPadding;

    // Adjust the scale factors according to the available screen space
    double factorX = screen.width / cameraImage!.height;
    double factorY = availableHeight / cameraImage!.width;
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          // Pass both screenSize and context to the function
          ...displayBoxesAroundRecognizedObjects(screenSize, context),
          Positioned(
            bottom: 25,
